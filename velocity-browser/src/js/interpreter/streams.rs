...
pub(super) fn make_readable_stream(underlying_source: Option<&JsValue>) -> JsValue {
    ...
    map.insert(
        "__type__".to_string(),
        JsValue::String("ReadableStream".to_string()),
    );
...
pub(super) fn call_readable_stream_method(
    ...
    match method {
        "getReader" => {
            ...
            reader.insert(
                ...
                JsValue::Number(stream_id as f64),
            );
            reader.insert(
                "closed".to_string(),
        ...
        "tee" => {
            ...
            let chunks: Vec<JsValue> =
                STREAM_BUFFERS.with(|b| b.borrow().get(&stream_id).cloned().unwrap_or_default());
            for chunk in &chunks {
        ...
        "values" | "asyncIterator" => {
            ...
            iter.insert(
                "__type__".to_string(),
                JsValue::String("AsyncIterator".to_string()),
            );
...
pub(super) fn call_reader_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    _args: &[JsValue],
) -> JsValue {
...
pub(super) fn call_readable_controller_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    args: &[JsValue],
) -> JsValue {
...
pub(super) fn make_writable_stream(underlying_sink: Option<&JsValue>) -> JsValue {
    ...
    map.insert(
        "__type__".to_string(),
        JsValue::String("WritableStream".to_string()),
    );
    map.insert("__stream_id__".to_string(), JsValue::Number(id as f64));
    map.insert("locked".to_string(), JsValue::Boolean(false));
...
pub(super) fn call_writable_stream_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    _args: &[JsValue],
) -> JsValue {
...
pub(super) fn call_writer_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    args: &[JsValue],
) -> JsValue {
...
pub(super) fn make_transform_stream(transformer: Option<&JsValue>) -> JsValue {
    ...
    map.insert(
        "__type__".to_string(),
        JsValue::String("TransformStream".to_string()),
    );
    map.insert(
        "__readable_id__".to_string(),
        JsValue::Number(readable_id as f64),
    );
    map.insert(
        "__writable_id__".to_string(),
        JsValue::Number(writable_id as f64),
    );
...
pub(super) fn call_transform_stream_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    _args: &[JsValue],
) -> JsValue {
...
pub(super) fn call_transform_controller_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    args: &[JsValue],
) -> JsValue {
...
pub(super) fn make_count_queuing_strategy(high_water_mark: f64) -> JsValue {
    ...
    map.insert(
        "__type__".to_string(),
        JsValue::String("CountQueuingStrategy".to_string()),
    );
    map.insert(
        "highWaterMark".to_string(),
        JsValue::Number(high_water_mark),
    );
    JsValue::Object(map)
}
...
pub(super) fn make_byte_length_queuing_strategy(high_water_mark: f64) -> JsValue {
    ...
    map.insert(
        "__type__".to_string(),
        JsValue::String("ByteLengthQueuingStrategy".to_string()),
    );
    map.insert(
        "highWaterMark".to_string(),
        JsValue::Number(high_water_mark),
...
pub(super) fn call_queuing_strategy_method(
    map: &HashMap<String, JsValue>,
    method: &str,
    args: &[JsValue],
) -> JsValue {
    match method {
        "size" => {
            ...
            let type_tag = map.get("__type__").and_then(|v| {
...
mod tests {
    ...
    fn count_queuing_strategy_structure() {
        ...
        if let JsValue::Object(m) = s {
            assert_eq!(
                ...
                &JsValue::String("CountQueuingStrategy".into())
            );
    ...
    fn byte_length_queuing_strategy_structure() {
        ...
        if let JsValue::Object(m) = s {
            assert_eq!(
                m.get("__type__").unwrap(),
                &JsValue::String("ByteLengthQueuingStrategy".into())
            );
    ...
    fn readable_stream_structure() {
        ...
        if let JsValue::Object(m) = s {
            assert_eq!(
                m.get("__type__").unwrap(),
                &JsValue::String("ReadableStream".into())
            );
    ...
    fn writable_stream_structure() {
        ...
        if let JsValue::Object(m) = s {
            assert_eq!(
                m.get("__type__").unwrap(),
                &JsValue::String("WritableStream".into())
            );
            assert_eq!(m.get("locked").unwrap(), &JsValue::Boolean(false));
        } else {
            panic!("expected Object");
    ...
    fn transform_stream_structure() {
        ...
        if let JsValue::Object(m) = s {
            assert_eq!(
                m.get("__type__").unwrap(),
                &JsValue::String("TransformStream".into())
            );
    ...
    fn stream_write_read_roundtrip() {
        ...
        if let JsValue::Object(rs_map) = rs {
            ...
            let _ = call_readable_controller_method(
                &ctrl,
                "enqueue",
    ...
    fn readable_stream_get_reader() {
        ...
        if let JsValue::Object(m) = rs {
            ...
            if let JsValue::Object(reader) = r {
                assert_eq!(
                    reader.get("__type__").unwrap(),
                    &JsValue::String("ReadableStreamDefaultReader".into())
                );
            } else {
                panic!("expected Object");
            }
    ...
    fn writable_stream_get_writer() {
        ...
        if let JsValue::Object(m) = ws {
            ...
            if let JsValue::Object(writer) = r {
                assert_eq!(
                    writer.get("__type__").unwrap(),
                    &JsValue::String("WritableStreamDefaultWriter".into())
                );
