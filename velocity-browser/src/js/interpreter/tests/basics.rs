...
fn varkind_let_const() {
    ...
    // let is block-scoped
    assert_eq!(eval_full("let x = 5; { let x = 10; } x"), JsValue::Number(5.0));
...
fn switch_case() {
    ...
    assert_eq!(eval_full("var x = 5; var r = 0; switch(x) { case 1: r = 10; break; default: r = 99; break; } r"), JsValue::Number(99.0));
    // Fall-through
    assert_eq!(eval_full("var x = 1; var r = 0; switch(x) { case 1: r = r + 1; case 2: r = r + 10; break; } r"), JsValue::Number(11.0));
}
