...
pub use generate::{WikiSearchResult, AutocompleteSuggestion, PaginatedSearchResult, SearchReport};
...
pub use markdown::{export_markdown, export_github_pages, render_page_markdown};
