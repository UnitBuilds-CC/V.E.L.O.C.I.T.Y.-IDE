...
fn generate_reading_reason(
    ...
    let calls_count = page.relationships
        .iter()
        .find(|(l, _)| l == "Calls")
        .map(|(_, t)| t.len())
        .unwrap_or(0);
...
mod tests {
    ...
    fn test_pagerank_simple_graph() {
        ...
        let edges = vec![
            ...
            GraphEdge { from: "C".to_string(), to: "A".to_string(), weight: 1.0 },
        ];
    ...
    fn test_pagerank_star_graph() {
        ...
        let edges = vec![
            GraphEdge { from: "B".to_string(), to: "A".to_string(), weight: 1.0 },
            GraphEdge { from: "C".to_string(), to: "A".to_string(), weight: 1.0 },
            GraphEdge { from: "D".to_string(), to: "A".to_string(), weight: 1.0 },
        ];
