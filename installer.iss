...
; The default below is the current release; override it with /DMyAppVersion=<x.y.z>.
...
#define MyAppURL        "https://github.com/UnitBuilds-CC/V.E.L.O.C.I.T.Y.-IDE"
...
[Icons]
; IDE — launches the GUI directly
Name: "{group}\{#MyAppFullName}"; Filename: "{app}\bin\{#MyAppExeName}"
; MCP Server — stdio JSON-RPC server (used by IDEs/editors)
