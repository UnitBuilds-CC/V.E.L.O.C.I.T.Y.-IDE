...
fn mirror_worker_events_into_timeline_appends_only_new_events() {
    ...
    let mut app = super::VelocityApp {
        ...
        workflow_versions: crate::editor::workflow_version::VersionRegistry::default(),
        policy: crate::editor::governance::PolicyEngine::default(),
        approvals: crate::editor::governance::ApprovalQueue::default(),
        secrets: crate::security::secrets::SecretStore::new(),
        connectors: crate::connectors::ConnectorRegistry::default(),
