...
fn mirror_worker_events_into_timeline_appends_only_new_events() {
    ...
    let mut app = super::VelocityApp {
        ...
        file_tree_rx: crossbeam_channel::unbounded().1,
        file_tree_tx: crossbeam_channel::unbounded().0,
        tree_build_in_flight: false,
        file_io_rx: crossbeam_channel::unbounded().1,
        file_io_tx: crossbeam_channel::unbounded().0,
        ...
        lsp_state: crate::editor::app::velocity_app::substructs::LspState::default(),
        ...
        workflow_state: crate::editor::app::velocity_app::substructs::WorkflowAppState::default(),
        governance: crate::editor::app::velocity_app::substructs::GovernanceState::default(),
        peer_state: crate::editor::app::velocity_app::substructs::PeerCollabState::default(),
