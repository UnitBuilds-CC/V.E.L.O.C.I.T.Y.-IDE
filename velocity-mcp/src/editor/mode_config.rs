...
impl KeyboardNavMap {
        ...
        Self {
            bindings: vec![
                KeyBinding {
                    ...
                    description: "Move to next focusable element".into(),
                },
                KeyBinding {
                    key: "Tab".into(),
                    modifiers: vec!["Shift".into()],
                    action: "focus_prev".into(),
                    description: "Move to previous focusable element".into(),
                },
                KeyBinding {
                    key: "Enter".into(),
                    modifiers: vec![],
                    action: "activate".into(),
                    description: "Activate focused element".into(),
                },
                KeyBinding {
                    key: "Space".into(),
                    modifiers: vec![],
                    action: "toggle".into(),
                    description: "Toggle focused checkbox/button".into(),
                },
                KeyBinding {
                    key: "Escape".into(),
                    modifiers: vec![],
                    action: "dismiss".into(),
                    description: "Close dialog or clear focus".into(),
                },
                KeyBinding {
                    key: "F6".into(),
                    modifiers: vec![],
                    action: "next_panel".into(),
                    description: "Move to next panel region".into(),
                },
                KeyBinding {
                    key: "F6".into(),
                    modifiers: vec!["Shift".into()],
                    action: "prev_panel".into(),
                    description: "Move to previous panel region".into(),
                },
                KeyBinding {
                    key: "F10".into(),
                    modifiers: vec![],
                    action: "context_menu".into(),
                    description: "Open context menu for focused element".into(),
                },
                KeyBinding {
                    key: "/".into(),
                    modifiers: vec!["Ctrl".into()],
                    action: "search".into(),
                    description: "Focus search field".into(),
                },
                KeyBinding {
                    key: "G".into(),
                    modifiers: vec!["Ctrl".into()],
                    action: "go_to_line".into(),
                    description: "Go to line number".into(),
                },
            ],
        }
    }
    ...
    pub fn bindings_by_category(&self, prefix: &str) -> Vec<&KeyBinding> {
        self.bindings
            .iter()
            .filter(|b| b.action.starts_with(prefix))
            .collect()
    }
}
...
mod tests {
    ...
    fn each_mode_has_right_panels() {
        for profile in WorkspaceProfile::ALL {
            let cfg = mode_config_for(profile);
            assert_eq!(
                cfg.right_panels().len(),
                3,
                "{:?} should have 3 right panels",
                profile
            );
        }
    }
